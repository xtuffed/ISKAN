...
<a href="managestudents.php">
        ...
        <li class="active">
          <a href="manageUsers.php"><i class="fa fa-user"></i> <span>Manage Users</span></a></li>
      </ul>
    </section>
    <!-- /.sidebar -->
  </aside>
        ...
        <section class="content">
          <div class="box">
            <div class="box-header">
              ...
              <button class="btn btn-info pull-right" type="button" data-toggle="modal" data-target="#modal-addstudent"><i class="fa fa-user-plus">Add User</i></button>
            </div>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <select class="form-control" name="organization" required>   
                            ...
                            <option value="4"> CNSM </option>
                            <option value="4"> CSSH </option>
                            <option value="4"> GRAD SCHOOL </option>
          ...
          <!-- /.modal-dialog -->
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-hover">
                ...
                <tbody>
                  <?php
                    $studentquery = "SELECT id, username, first_name, last_name, email, type, organization.orgCode as org FROM users, organization WHERE users.orgID = organization.orgID";
                   ...
                   ?>
                <tr>
                  <td><?php echo $studentq['username'];?></td>
                  <td><?php echo $studentq['first_name'];?></td>
                  <td><?php echo $studentq['last_name'];?></td>
                  <td><?php echo $studentq['email'];?></td>
                  <td><?php echo $studentq['type'];?></td>
                  <td>
                      <button type="button" class="btn btn-primary btn-blk" data-toggle="modal" data-target="#editstudent" href="editstudents.php?id=<?php echo $studentq['id']; ?>"><span class="fa fa-edit"></span></button>
                      <button type="button" class="btn btn-danger btn-blk" data-toggle="modal" data-target="#delete-modal" href="deleteUser.php?id=<?php echo $studentq['id']; ?>"><span class="fa fa-remove"></span></button>
