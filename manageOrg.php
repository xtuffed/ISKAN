...
<a href="managestudents.php">
        ...
        <section class="content">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Colleges Data</h3>
              <button class="btn btn-info pull-right" type="button" data-toggle="modal" data-target="#modal-addorg"><i class="fa fa-user-plus">Add College</i></button>
            </div>
            

            <!-- /. modal add students -->
          <div class="modal fade" id="modal-addorg">
              ...
              <div class="modal-body">
                  <form action="addOrg.php" method="post">
                    <div class="form-group has-feedback">
                     <input type="text" class="form-control" placeholder="Organization Code" name="orgcode" required="required">
                     <span class="fa fa-credit-card form-control-feedback"></span>
                </div>
                 <div class="form-group has-feedback">
               <input type="text" class="form-control" placeholder="Organization Name" name="orgname" required="required">
              ...
              <table id="example1" class="table table-bordered table-hover">
                ...
                <tbody>
                  <?php
                    ...
                    while ($orgq = $orgresult->fetch_assoc()) {
                      
                   ?>
                <tr>
                  <td onclick="window.location='orgStudent.php?id=<?php echo $orgq['orgID'];?>'"><?php echo $orgq['orgCode'];?></td>
                  <td onclick="window.location='orgStudent.php?id=<?php echo $orgq['orgID'];?>'"><?php echo $orgq['orgName'];?></td>
                  <td>
                      <button type="button" class="btn btn-primary btn-blk" data-toggle="modal" data-target="#editorg" href="editorg.php?id=<?php echo $orgq['orgID']; ?>"><span class="fa fa-edit"></span></button>
                      <button type="button" class="btn btn-danger btn-blk" data-toggle="modal" data-target="#deleteorg-modal" href="deleteOrg.php?id=<?php echo $orgq['orgID']; ?>"><span class="fa fa-remove"></span></button>
  ...
  <!-- /.content-wrapper -->
  <?php
  include('editorg_modal.php');
  include('deleteorg_modal.php');
