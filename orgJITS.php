...
<div class="wrapper">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="#"><i class="fa fa-circle-o"></i> MAIN GATE</a></li>
            <li><a href="orgSMS.php"><i class="fa fa-circle-o"></i> OSSA Building</a></li>
            <li><a href="orgNASSA.php"><i class="fa fa-circle-o"></i> Y Building</a></li>
          </ul>
        </li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        JITS
        <small>Junior Information Technology Society</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="home.php"><i class="fa fa-dashboard"></i> Home</a></li>
        <li>Organizations</li>
        <li class="active">JITS</li>
      </ol>
    </section>
          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-hover">
                ...
                <tbody>
                  <?php
                  $orgstudentq = "SELECT studentID, idnumber, first_name, last_name FROM students WHERE studentID in(SELECT studentID FROM orgstudent WHERE orgID = 2)";
                  ...
                  while ($orgstudentdata = $orgstudentresult->fetch_assoc()) {
                   ...
                   <tr>
                     ...
                     <td><button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#unregisterJITS-modal" href="unregJITS.php?id=<?php echo $orgstudentdata['studentID']; ?>">Unregister</button></td>
                   </tr>
                   <?php }?>
                </tbody>
                <tfoot>
