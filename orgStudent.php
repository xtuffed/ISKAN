...
<div class="wrapper">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li>
          <a href="eventshandled.php">
            <i class="fa fa-calendar"></i> <span>Manage Building</span>
          </a>
        </li>
        <li class="active">
          <a href="manageOrg.php">
            <i class="fa fa-institution"></i> <span>Colleges</span>
          </a>
        </li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <?php 
      $orgsq = "SELECT * FROM organization WHERE orgID = '$orgid'";
      $orgsr = $conn->query($orgsq);
      $orgsdata = $orgsr->fetch_assoc();
      ?>
      <h1>
        <?php echo $orgsdata['orgCode']; ?>
        <small><?php echo $orgsdata['orgName']; ?></small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="home.php"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="manageOrg.php">Manage Organizations</a></li>
        <li class="active"><?php echo $orgsdata['orgCode']; ?></li>
      </ol>
    </section>
          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-hover">
                ...
                <tbody>
                  <?php
                  $orgstudentq = "SELECT studentID, idnumber, first_name, last_name FROM students WHERE studentID in(SELECT studentID FROM orgstudent WHERE orgID = '$orgid')";
                  ...
                  while ($orgstudentdata = $orgstudentresult->fetch_assoc()) {
                   ...
                   <tr>
                     ...
                     <td><button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#unregister-modal" href="unregisterStudent.php?id=<?php echo $orgstudentdata['studentID']; ?>&orgid=<?php echo $orgid; ?>">Unregister</button></td>
                   </tr>
                   <?php }?>
                </tbody>
                <tfoot>
